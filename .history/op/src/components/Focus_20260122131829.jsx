   ...
   <>
    <section className="py-16 px-8 lg:px-20 bg-white">
        <div className="container mx-auto" id="programs">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 px-1 lg:px-4 -mt-10 lg:mt-0">
            {focusAreas.map((area) => (
              <div 
                key={area.id}
              ...
              >
                ...
                <p className="text-sm text-gray-600 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 max-w-[140px] hidden lg:">
                  {area.description}
                </p>
              </div>
            ))}
