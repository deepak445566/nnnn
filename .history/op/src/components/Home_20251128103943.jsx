...
export default function Home() {
	return (
		<div className="min-h-screen flex flex-col md:flex-row">
			{/* Left section */}
			<section className="w-full md:w-1/2 flex items-center justify-center bg-gradient-to-br from-indigo-600 to-purple-600 text-white p-8">
				<div className="max-w-lg">
					<h1 className="text-4xl md:text-5xl font-extrabold mb-4">Welcome to the Home Page</h1>
					...
					<div className="flex gap-4">
						<button className="bg-white text-indigo-700 font-semibold px-4 py-2 rounded shadow">Get Started</button>
			...
			{/* Right section */}
			<section className="w-full md:w-1/2 flex items-center justify-center bg-gray-50 p-8">
				<div className="max-w-md text-center">
					...
					<p className="text-gray-600">
						...
						supplemental content. On smaller screens the layout stacks vertically.
					</p>
				</div>
			</section>
		</div>
