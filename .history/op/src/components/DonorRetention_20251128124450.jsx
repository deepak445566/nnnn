...
const DonorRetention = () => {
  return (
    <div className="h-[120vh] bg-gradient-to-br from-blue-50 to-indigo-100 flex">
      {/* Left Content Section */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 mt-">
        <div className="max-w-2xl">
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="text-4xl lg:text-4xl font-bold text-gray-800 mb-6 leading-tight"
          >
