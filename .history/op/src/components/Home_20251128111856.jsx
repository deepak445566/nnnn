  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#15362D]">
      ...
      <section className="w-full md:w-3/5  md:h-[115vh] flex flex-col">
        ...
        <div className="w-full h-[40%] h-auto flex  items-center lg:px-15">
          <h1 className="text-5xl  lg:text-6xl font-extrabold text-white max-w-xl  new tracking-tight leading-tight">
