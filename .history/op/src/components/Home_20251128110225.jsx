...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#15362D]">
      ...
      <section className="w-full md:w-3/5 p-4 h-[110vh] flex flex-col">
        {/* Top - 40%: single centered heading */}
        <div className="w-full h-[30%] flex items-center justify-center ">
          <h1 className="text-3xl md:text-5xl font-extrabold text-white text-center new">
            Empowering Lives Through Education
          </h1>
        </div>

        {/* Bottom - 60%: background from back.svg with main.avif centered on top */}
        <div className="w-full h-[70%] flex items-center justify-center mt-6">
          <div className="w-full flex items-center justify-center bg-[url('/images/back.svg')] bg-center bg-cover rounded-lg p-6 h-[70vh] mt-7">
            <img
              src="/images/main.avif"
              alt="Left bottom"
              className="max-w-full h-[75vh] rounded shadow-lg object-contain mb-8"
            />
          </div>
        </div>
      </section>
