...
import { Ambulance, Phone, Stethoscope, Home } from 'lucide-react'

function AnimalRescue() {
  return (
    <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-5xl shadow-lg overflow-hidden my-8 p-1">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="text-center">
                ...
                <div className="text-white/80 text-xs">Recovery Rate</div>
              </div>
              <div className="text-center">
        ...
        <div className="md:col-span-2 pt-3">
          <div className="mb-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-2xl font-bold text-gray-800 exo uppercase">
          ...
          {/* Services Icons */}
          <div className="grid grid-cols-2 gap-3 mb-6 exo">
            ...
            <div className="flex items-center gap-3 bg-white p-3 rounded-lg shadow-sm">
              ...
              <div>
                ...
                <div className="text-gray-500 text-xs">Recovery & Foster Care</div>
              </div>
            </div>
          </div>
