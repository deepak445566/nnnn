...
<div className="grid grid-cols-2 lg:grid-cols-4 gap-10 mb-20 px-4">
  {/* Education */}
  <div className="flex flex-col items-center text-center group">
    <div className="relative mb-6">
      ...
      <div className="relative h-38 w-38 lg:h-58 lg:w-58 rounded-full overflow-hidden border-4 border-white shadow-xl group-hover:border-[#50C779] transition-all duration-300">
        <img 
          src="/images/mc1.avif" 
          alt="Education" 
