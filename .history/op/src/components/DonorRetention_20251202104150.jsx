        ...
        <div className="max-w-2xl">
         ...
         Empower change—your donation creates hope and transforms lives.
          ...
          <div className="flex flex-col   gap-3">
            <button className="bg-[#15362D] text-white px-8 py-3 w-50 exo text-xl rounded-2xl font-semibold hover:bg-white hover:text-green-900 hover:border hover:border-green-900 transition-all duration-400">
              Donate Now
            </button>
           
             
              <h1 className="text-[#15362D] font-medium exo text-2xl">
              Call Us: +91 96672 77348
              </h1>
