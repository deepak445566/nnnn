      ...
      <section className="w-full md:w-2/5 flex flex-col mt-10">
        ...
        Every act of kindness—donation, volunteering, or partnership—brings us closer to a world where everyone thrives.
            ...
            <div className="flex items-center justify-center gap-4">
              <button className="bg-[#50C779] text-white px-8 py-3 rounded font-semibold new text-xl">
                Join With Us
              </button>
              <button className="border-2 rounded-2xl border-[#50C779] text-white px-8 py-3 rounded">
                Learn More
              </button>
            </div>
          </div>
