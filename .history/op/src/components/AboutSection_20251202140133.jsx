          ...
          <div className="w-full lg:w-1/2">
            <div className="relative bg-[#FFFFFF]">
              ...
              <img 
                ...
                className="rounded-2xl shadow-xl w-[80%] h-auto object-contain bg-[#FFFFFF]"
              />
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                that every child deserves equal opportunities for growth, education, and a dignified life.We don't just provide aid; we build futures. Our approach combines immediate 
                  relief with sustainable development, ensuring that every intervention creates 
