            ...
            <div className="grid md:grid-cols-2 gap-8 p-8">
              ...
              <div>
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800">Winter Clothing Drive</h4>
                        <p className="text-gray-600 text-sm">Warm woolens, jackets, and blankets for winter</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800">School Uniform Program</h4>
                        <p className="text-gray-600 text-sm">Complete school uniforms for underprivileged students</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800">Essential Clothing Kit</h4>
                        <p className="text-gray-600 text-sm">Basic clothing items for daily wear</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-[#50C779] to-[#3EAE66] p-6 rounded-xl text-white">
                  <h3 className="text-xl font-bold mb-3">Warm Someone's Winter</h3>
                  <p className="mb-4">Your donated clothes can bring comfort and warmth</p>
