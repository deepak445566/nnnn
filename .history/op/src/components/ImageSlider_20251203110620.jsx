          ...
          <div className="relative w-full h-full">
            ...
            <div className="relative z-20 h-full flex items-center px-4 sm:px-6 lg:px-20">
              <div className="max-w-2xl text-white mt-10 md:mt-0">
                ...
                <button on className="bg-[#50C779] hover:bg-[#3EAE66] text-white px-6 py-3 sm:px-8 sm:py-3 rounded-2xl font-semibold text-base sm:text-lg transition duration-300 shadow-lg hover:scale-105">
                  Support a Child
                </button>
              </div>
            </div>
