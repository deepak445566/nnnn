      ...
      <section className="w-full md:w-2/5 flex flex-col p-6 md:p-8">
        ...
        <div className="w-full md:h-1/2 h-auto flex items-center justify-center">
          <img
            src="/images/main.avif"
            alt="Right top"
            className="max-w-full md:max-h-[35vh] max-h-[30vh] rounded-lg shadow-lg object-contain"
          />
        </div>
        ...
        <div className="w-full md:h-1/2 h-auto flex items-center justify-center">
          <div className="text-center">
            <h3 className="text-2xl font-semibold mb-3 text-white">Join Our Mission</h3>
