...
const MiniVolunteerCard = ({ volunteer }) => {
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      >
        {/* Header */}
        <div className="bg-blue-700 text-white py-2 px-4 text-center">
          <h2 className="font-bold">AAK VOLUNTEER CARD</h2>
        </div>
        ...
        {/* Footer */}
        <div className="bg-gray-100 py-2 px-4 text-center text-xs border-t">
          <div className="font-semibold">Emergency: 99232 25066</div>
        </div>
      </div>
    </div>
  );
