  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      >
        ...
        >
          <div className="h-15 w-17 rounded-full overflow-hidden bg-white p-1">
            <img 
              src='/images/logo.jpg' 
              alt="Logo" 
              ...
              onError={(e) => {
                ...
                e.target.parentElement.innerHTML = '<div class="h-full w-full flex items-center justify-center bg-gray-200 text-gray-600 text-xs">LOGO</div>';
              }}
            />
          </div>
