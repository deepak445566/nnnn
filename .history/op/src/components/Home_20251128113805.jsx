  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#15362D]">
      ...
      <section className="w-full md:w-2/5 flex flex-col">
        {/* Top 50%: image */}
        <div className="w-full md:h-1/2 h-auto flex items-center justify-center rounded-2xl">
          <img
            src="/images/child.avif"
            alt="Right top"
            className="w-[90%] rounded-2xl lg:max-w-full h-[55vh] rounded-lg shadow-lg object-contain"
          />
        </div>
