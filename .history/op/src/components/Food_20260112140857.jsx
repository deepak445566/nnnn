              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="bg-[#50C779]/10 p-4 rounded-lg text-center">
                    <div className="text-3xl font-bold text-[#50C779]">50K+</div>
                  ...
                  <div className="bg-[#3EAE66]/10 p-4 rounded-lg text-center">
                    ...
                    <div className="text-gray-600 text-sm">Distribution Points</div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-[#50C779] to-[#3EAE66] p-6 rounded-xl text-white">
                  <h3 className="text-xl font-bold mb-3">Feed the Hungry</h3>
                  <p className="mb-4">Your contribution can provide meals to those in need</p>
