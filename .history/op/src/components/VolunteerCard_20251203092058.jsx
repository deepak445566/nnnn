...
const MiniVolunteerCard = ({ volunteer }) => {
    ...
    try {
      ...
      const canvas = await html2canvas(cardElement, {
        ...
        onclone: (clonedDoc, element) => {
          ...
          // FIX: Ensure organization name text shows completely (remove ellipsis)
          const orgName = element.querySelector('h2');
          if (orgName) {
            orgName.style.cssText = `
              font-family: Arial, sans-serif;
              font-size: 18px; /* Reduced slightly for better fit */
              font-weight: 600;
              ...
              max-height: 68px; /* Match logo height */
              display: flex;
              align-items: center;
            `;
          }
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      >
        {/* Header - UPDATED with more space for text */}
        <div 
          ...
          style={{
            ...
            alignItems: 'center',
            padding: '8px 16px',
            gap: '12px' // Reduced gap for more text space
          }}
        >
          ...
          {/* Organization Name - UPDATED: No ellipsis, shows complete text */}
          <h2 
            ...
            style={{
              ...
              overflow: 'visible', // Shows all text
