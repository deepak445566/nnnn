...
const VolunteerGallery = () => {
  ...
  // Fetch all volunteers - UPDATED with role sorting
  const fetchVolunteers = async () => {
    try {
      ...
      const sortedMock = mockVolunteers.sort((a, b) => {
        const roleOrder = { 'president': 3, 'vice-president': 2, 'employee': 1 };
        return (roleOrder[b.role] || 0) - (roleOrder[a.role] || 0);
      });
      
      setVolunteers(sortedMock);
      setFilteredVolunteers(sortedMock);
      
      const counts = {
        all: sortedMock.length,
        president: sortedMock.filter(v => v.role === 'president').length,
        'vice-president': sortedMock.filter(v => v.role === 'vice-president').length,
        employee: sortedMock.filter(v => v.role === 'employee').length
      };
      setRoleCounts(counts);
  ...
  // UPDATED filter volunteers with new filters
  useEffect(() => {
  ...
  // NEW: Download all ID cards as ZIP
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-gray-100 p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="12">12 volunteers</option>
                    <option value="24">24 volunteers</option>
                    <option value="48">48 volunteers</option>
                  </select>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto mb-4">
        <div className="flex justify-between items-center">
          <p className="text-gray-600">
            Showing {currentVolunteers.length} of {filteredVolunteers.length} volunteers
      ...
      {/* Volunteers Display - UPDATED with roles */}
      ...
      {/* Modal for Full ID Card View - UPDATED with enhanced view */}
      {selectedVolunteer && (
            ...
            <div className="p-4">
              ...
              <div className="mb-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 mt-2">
                      ...
                      <div className="flex items-center gap-1 text-gray-600">
                        ...
                        <span>Joined {new Date(selectedVolunteer.joinDate).toLocaleDateString('en-IN')}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-gray-600">{selectedVolunteer.address}</p>
                </div>
              </div>
      ...
      {/* Footer - UPDATED with role summary */}
