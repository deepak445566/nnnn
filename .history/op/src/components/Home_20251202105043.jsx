          ...
          <div className="hidden lg:flex items-center space-x-8 exo">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-gray-200 hover:text-white font-medium new text-lg transition duration-300 relative group exo"
              >
                {item.name}
      ...
      <div className="min-h-screen flex flex-col md:flex-row bg-[#15362D] rounded-b-[5vh] lg:rounded-b-[15vh] ">
        ...
        <section className="w-full md:w-3/5 md:h-[115vh] flex flex-col rounded-2xl">
          ...
          <div className="w-full h-[40%] flex items-center px-8 lg:px-25 py-10">
            <h1 className="text-4xl lg:text-5xl leading-14 lg:leading-18 font-bold text-white new uppercase ">
              Soorveer Yuva Sangathan Trust
            </h1>
          </div>
