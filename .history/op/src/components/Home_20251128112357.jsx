  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#15362D]">
      ...
      <section className="w-full md:w-3/5  md:h-[115vh] flex flex-col">
        ...
        <div className="w-full h-[40%]  flex  items-center px-8  py-10">
        ...
        <div className="w-full md:h-[60%] h-auto flex items-center justify-center lg:mt-6">
          <div className="w-[100%] flex items-center justify-center bg-[url('/images/back.svg')]  bg-cover rounded-lg h-[35vh] md:h-[65vh]  mt-7">
            <img
              src="/images/main.avif"
              alt="Left bottom"
              className="max-w-full h-auto md:max-h-[75vh] max-h-[45vh] rounded shadow-lg object-contain mb-15"
            />
          </div>
        </div>
      </section>
