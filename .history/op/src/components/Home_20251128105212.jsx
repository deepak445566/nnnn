  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#15362D]">
      ...
      <section className="w-full md:w-3/5 p-4 h-[110vh] flex flex-col">
        ...
        <div className="w-full h-[40%] flex items-center justify-center bg-amber-800">
          <h1 className="text-3xl md:text-5xl font-extrabold text-white text-center">
            Empowering Lives Through Education
          </h1>
        </div>

        {/* Bottom - 60%: single centered image */}
        <div className="w-full h-[60%] flex items-center justify-center mt-6 bg-amber-300">
          <div className="w-full flex items-center justify-center">
            {/* Replace the src with your image path, e.g. '/logo.png' or import from assets */}
            <img
              src="/images/main.avif"
              alt="Left bottom"
              className="max-w-full max-h-[80%] rounded-lg shadow-lg object-contain"
            />
          </div>
        </div>
      </section>
