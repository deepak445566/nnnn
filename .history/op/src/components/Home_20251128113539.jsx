      ...
      <section className="w-full md:w-2/5 flex flex-col">
        ...
        <div className="w-full md:h-1/2 h-auto flex items-center justify-center">
          <img
            ...
            alt="Right top"
            className="max-w-full h-[55vh] rounded-lg shadow-lg object-contain"
          />
        </div>

        {/* Bottom 50%: text and two buttons */}
        <div className="w-full md:h-1/2 h-auto flex items-center justify-center mt-10">
          <div className="text-center">
           
            <p className="text-gray-200 mb-4 max-w-xl p-3 mx-auto new text-2xl hok">
        Every act of kindness—donation, volunteering, or <br></br>partnership—brings us closer to a world where <br></br>everyone thrives.
            </p>
