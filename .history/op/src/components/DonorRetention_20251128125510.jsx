        ...
        <div className="max-w-2xl">
         ...
         Empower change—your donation creates hope and transforms lives.
          ...
          <div className="flex flex-col   gap-3">
            <button className="bg-[#15362D] text-white px-8 py-3 w-50 exo text-xl rounded font-semibold hover:bg-white hover:text-green-900 hover:border hover:border-green-900">
              Donate Now
            </button>
