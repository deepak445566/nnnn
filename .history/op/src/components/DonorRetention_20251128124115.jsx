    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex">
      ...
      <div className="hidden lg:block w-1/2 bg-gradient-to-br from-blue-400 to-purple-500 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-white text-center">
            <motion.div 
              ...
              className="w-64 h-64 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-8"
            >
        ...
        <motion.div 
          ...
          className="absolute bottom-1/3 right-1/3 w-6 h-6 bg-white/20 rounded-full"
        />
      </div>
    </div>
  );
