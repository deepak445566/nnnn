...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#15362D]">
      ...
      <section className="w-full md:w-3/5 p-4 md:h-[110vh] flex flex-col">
        {/* Top - 40% on md, auto on mobile: single centered heading */}
        <div className="w-full md:h-[40%] h-auto flex items-center justify-center py-8">
        ...
        <div className="w-full md:h-[60%] h-auto flex items-center justify-center mt-6">
          <div className="w-[90%] flex items-center justify-center bg-[url('/images/back.svg')] bg-center bg-cover rounded-lg p-6 md:h-[70vh] h-auto mt-7">
            <img
              src="/images/main.avif"
              alt="Left bottom"
              className="max-w-full h-auto md:max-h-[75vh] max-h-[40vh] rounded shadow-lg object-contain mb-8"
            />
          </div>
        </div>
      </section>
