    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-[#15362D]">
      ...
      <section className="w-full md:w-3/5  md:h-[115vh] flex flex-col">
        ...
        <div className="w-full md:h-[60%] h-auto flex items-center justify-center lg:mt-6">
          <div className="w-[100%] flex items-center justify-center bg-[url('/images/back.svg')]  bg-cover rounded-lg h-[26vh] md:h-[65vh]  mt-7">
            <img
              src="/images/main.avif"
              alt="Left bottom"
              className="max-w-full  lg:h-[75vh]  rounded shadow-lg object-contain lg:mb-15"
            />
          </div>
        </div>
      </section>
