          ...
          {volunteers.map((volunteer, index) => (
            <div key={volunteer.id} className="group text-center">
                ...
                <div className="relative h-60 w-60 lg:h-72 lg:w-72 rounded-full overflow-hidden border-8 border-white shadow-2xl group-hover:border-[#50C779] transition-all duration-500">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-8">
                    <div className="transform translate-y-10 group-hover:translate-y-0 transition-transform duration-500">
                      ...
                      <div className="text-[#50C779] font-medium">{volunteer.role}</div>
                    </div>
                  </div>
                </div>
                
                {/* Number Badge */}
                <div className="absolute -top-3 -right-3 h-14 w-14 bg-gradient-to-r from-[#50C779] to-[#3EAE66] rounded-full flex items-center justify-center text-white font-bold text-xl shadow-xl">
                  {index + 1}
                </div>
              </div>
              ...
              <div className="max-w-xs mx-auto">
                ...
                <div className="text-[#50C779] font-medium mb-3">{volunteer.role}</div>
                <p className="text-gray-600 text-sm leading-relaxed">{volunteer.description}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-5xl font-bold text-[#50C779] mb-3">150+</div>
              <div className="text-gray-700 font-semibold">Active Volunteers</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-[#50C779] mb-3">5,000+</div>
              <div className="text-gray-700 font-semibold">Hours Contributed</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-[#50C779] mb-3">50+</div>
