...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#15362D] rounded-b-[15vh]">
      ...
      <section className="w-full md:w-3/5  md:h-[115vh] flex flex-col rounded-2xl">
        ...
        <div className="w-full md:h-[60%] h-auto flex items-center justify-center lg:mt-6">
          <div className="w-[100%] flex items-center justify-center bg-[url('/images/back.svg')]  bg-cover rounded-bl-2xl h-[27vh] md:h-[65vh]  mt-7">
            <img
