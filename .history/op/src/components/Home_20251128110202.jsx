    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-[#15362D]">
      ...
      <section className="w-full md:w-3/5 p-4 h-[110vh] flex flex-col">
        ...
        <div className="w-full h-[70%] flex items-center justify-center mt-6">
          <div className="w-full flex items-center justify-center bg-[url('/images/back.svg')] bg-center bg-cover rounded-lg p-6 h-[70vh] mt-6">
            <img
              src="/images/main.avif"
              alt="Left bottom"
              className="max-w-full h-[75vh] rounded shadow-lg object-contain"
            />
          </div>
        </div>
      </section>
