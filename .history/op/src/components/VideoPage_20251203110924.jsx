  ...
  return (
    <section className="py-16 px-8 lg:px-20 bg-white">
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center" id="work">
  ...
  <div className="max-w-2xl">
    ...
    <div className="bg-gradient-to-r from-[#50C779]/10 to-white p-8 rounded-2xl border border-[#50C779]/20">
      ...
      <div className="space-y-4">
        <button onClick={} className="w-full bg-gradient-to-r from-[#50C779] to-[#3EAE66] hover:from-[#3EAE66] hover:to-[#50C779] text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center gap-3">
